 ...
 * </p>
 * <ul>
 *   <li>{@link aspectj.impl.AspectImpl#getBase_Class <em>Base Class</em>}</li>
 *   <li>{@link aspectj.impl.AspectImpl#isPrivileged <em>Is Privileged</em>}</li>
 *   <li>{@link aspectj.impl.AspectImpl#getPerType <em>Per Type</em>}</li>
 *   <li>{@link aspectj.impl.AspectImpl#getPerPointCut <em>Per Point Cut</em>}</li>
 *   <li>{@link aspectj.impl.AspectImpl#getDeclaredParents <em>Declared Parents</em>}</li>
 *   <li>{@link aspectj.impl.AspectImpl#getDeclaredImplements <em>Declared Implements</em>}</li>
 *   <li>{@link aspectj.impl.AspectImpl#getPrecedes <em>Precedes</em>}</li>
 *   <li>{@link aspectj.impl.AspectImpl#getPrecededBy <em>Preceded By</em>}</li>
 * </ul>
 *
 * @generated
 */
