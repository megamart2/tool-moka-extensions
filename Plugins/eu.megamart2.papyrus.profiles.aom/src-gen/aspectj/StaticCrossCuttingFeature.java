 ...
 * </p>
 * <ul>
 *   <li>{@link aspectj.StaticCrossCuttingFeature#getBase_Feature <em>Base Feature</em>}</li>
 *   <li>{@link aspectj.StaticCrossCuttingFeature#getOnType <em>On Type</em>}</li>
 * </ul>
 *
 * @see aspectj.AspectjPackage#getStaticCrossCuttingFeature()
 * @model
 * @generated
 */
public interface StaticCrossCuttingFeature extends EObject {
	 ...
	 * @see aspectj.AspectjPackage#getStaticCrossCuttingFeature_Base_Feature()
	...
	/**
	 * Sets the value of the '{@link aspectj.StaticCrossCuttingFeature#getBase_Feature <em>Base Feature</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see aspectj.AspectjPackage#getStaticCrossCuttingFeature_OnType()
	 * @model required="true" ordered="false"
	 * @generated
	 */
