 ...
 */
public class MokaValidationPlugin extends Plugin {

	//The shared instance.
	private static MokaValidationPlugin plugin;

	/**
	 * The constructor.
	 */
	public MokaValidationPlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static MokaValidationPlugin getDefault() {
		return plugin;
	}
}
